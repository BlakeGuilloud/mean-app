...
module.exports = "<div class=\"row\">\n  <form class=\"col-sm-4\" (ngSubmit)=\"onSubmit()\">\n      <div class=\"form-group\">\n        <label for=\"username\">Username</label>\n        <input class=\"form-control\" type=\"text\" [(ngModel)]=\"newUser.username\" name=\"username\" required />\n      </div>\n      <div class=\"form-group\">\n        <label for=\"email\">Email</label>\n        <input class=\"form-control\" type=\"text\" [(ngModel)]=\"newUser.email\" name=\"email\" required />\n      </div>\n      <button class=\"btn btn-success\" type=\"submit\">Submit</button>\n    </form>\n</div>"
...
var AddUserComponent = (function () {
    function AddUserComponent(userServ) {
...
], AddUserComponent.prototype, "addUser", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__list_users_list_users_component__ = __webpack_require__("../../../../../src/app/list-users/list-users.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_5__add_user_add_user_component__["a" /* AddUserComponent */],
            __WEBPACK_IMPORTED_MODULE_6__list_users_list_users_component__["a" /* ListUsersComponent */]
        ],
        imports: [
...
module.exports = "<div class=\"container\">\n  <h2>Users</h2>\n\n  <table class=\"table\">\n    <thead>\n      <tr>\n        <th>ID</th>\n        <th>Username</th>\n        <th>Email</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let user of users\">\n        <td>{{user._id}}</td>\n        <td>{{user.username}}</td>\n        <td>{{user.email}}</td>\n        <td>\n          <button class=\"btn btn-danger btn-sm\" type=\"button\" (click)=\"deleteUser(user); $event.stopPropagation();\">\n            Delete\n          </button>\n        </td>\n      </tr>\n    </tbody>\n  </table>\n\n  <app-add-user (addUser)='onAddUser($event)'></app-add-user>\n</div>"
...
var ListUsersComponent = (function () {
    function ListUsersComponent(userServ) {
        this.userServ = userServ;
        this.users = [];
    }
    ...
    ListUsersComponent.prototype.loadUsers = function () {
        var _this = this;
        this.userServ.getAllUsers()
            .subscribe(function (response) { return _this.users = response; });
    };
    ListUsersComponent.prototype.deleteUser = function (user) {
        var _this = this;
        this.userServ.deleteUser(user._id)
            .subscribe(function (response) { return _this.users = _this.users.filter(function (u) { return u !== user; }); });
    };
    ListUsersComponent.prototype.onAddUser = function (newUser) {
...
ListUsersComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/list-users/list-users.component.html"),
        styles: [__webpack_require__("../../../../../src/app/list-users/list-users.component.css")]
    }),
...
var UserService = (function () {
    ...
    UserService.prototype.deleteUser = function (userId) {
        var URI = this.serverApi + "/users/" + userId;
